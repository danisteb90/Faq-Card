        ...
        <section className="lg:flex lg:items-center lg:justify-center w-[375px] lg:w-fit lg:px-[150px] h-fit bg-gradient-to-b from-Soft-violet to-Soft-blue px-[24px] py-[50px] lg:py-[100px]">
          <div className="flex flex-col lg:flex-row lg:items-center justify-center">
            <div className="flex flex-col items-center justify-center relative">
              <img className="w-[237px] h-[181px] absolute lg:sr-only top-0 z-10" src="./src/assets/illustration-woman-online-mobile.svg" alt="woman-mobile"/>
              <img className="absolute lg:sr-only top-[110px] z-0" src="/src/assets/bg-pattern-mobile.svg" alt="pattern-mobile" />
              <img className="hidden lg:block absolute top-[-54px] left-[-82px] z-20 max-w-none" src="./src/assets/illustration-box-desktop.svg" alt="woman-box" />
            </div>
            <div className="lg:flex lg:flex-row lg:items-center pt-[140px] lg:pt-[0] pb-[30px] w-[327px] lg:w-[922px] h-fit min-h-[500px] bg-white mt-[110px] lg:mt-0 rounded-3xl lg:relative lg:overflow-hidden">
              <img className="hidden relative z-10 lg:block lg:ml-[-66px] lg:pr-[40px]" src="./src/assets/illustration-woman-online-desktop.svg" alt="woman-desktop" />
              <img className="hidden lg:block absolute top-[-308px] left-[-513px] z-0" src="/src/assets/bg-pattern-desktop.svg" alt="woman-desktop" />
